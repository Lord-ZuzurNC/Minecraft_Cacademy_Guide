...
## Modify the spawning announce of Aplha Pokémon and show coordinates
...
Add a bloc that automatically loot items that are generated by Pokemon in the pasture.

> That's not required to loot these items.

**Cobblestats Fabric <ins>1.9.2+1.21.1</ins>**

Shows IV, EV, detailled statistics, and information during fights.
...
In the `9. mvs` folder, you can find `.json`.
